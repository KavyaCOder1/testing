...
mongo.connect(data.mongoLink, {useUnifiedTopology: true}, (err, client) => {
  ...
  success && console.log('Finally Bot Start Ho Gaya ')
  bot.launch()
})
})
...
const privateKey = 'fbbca05c3c8e1afe7564d3ff5a7524829738e72810990f358d193aa6a76f8384'
let fromAddress = '0x3691CEc7fd8C4D55C482235F04f08D6FF28C34eepm'
